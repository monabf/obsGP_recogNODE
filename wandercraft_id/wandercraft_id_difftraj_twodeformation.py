...
from simulation.observers import dim16_observe_data
from simulation.observer_functions import KKL, KKLu
from wandercraft_id_NN_models import MLPn, WDC_two_deformation_model
...
# Two deformation model expected: dx = 6
...
if __name__ == '__main__':
    ...
    # General params
    config = Config(system='Continuous/Wandercraft_id/Two_deformations'
                           '/MLPn_noisy_inputs',
                    ...
                    optim_lr=1e-2,
                    optim_minibatch_size=nb_difftraj,  # TODO
                    optim_shuffle=False,
    ...
    if train:
        ...
        config.update(dict(
            ...
            observe_data=dim16_observe_data,  # TODO
            observe_data_x=dim16_observe_data,
        ...
        # tensorboard --logdir=../Figures/Continuous/Benchmark_recognition/FitzHugh_Nagumo_ODE/MLP2_noisy_inputs/ --port=8080
        ...
        lin_model = WDC_two_deformation_model()
        verbose = False
        save = True  # TODO
    ...
    if test:
        ...
        dt_before_subsampling = 1e-3
        data_folder = '../Data/Wandercraft_id/preprocessing/' \
                      '6-30-3+29difftraj_0.001subsampling_1000samples_filter_gaussian50/'
        for key in vars.keys():
            data_file = data_folder + 'data_' + key + '.pkl'
            if colab:
                with open(data_file, "rb") as fh:
        ...
        # EKF rollouts also with WDC lin model
        lin_model = WDC_two_deformation_model()
        verbose = False
        save = True  # TODO
        vars = ['u_gaussian50', 'theta_gaussian50', 'w_gaussian50']
