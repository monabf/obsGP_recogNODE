...
from eval_WDC_data import plot_NODE_lin_rollouts, plot_NODE_full_rollouts
...
if __name__ == '__main__':
    ...
    config = Config(system='Continuous/Wandercraft_id/MLPn_noisy_inputs/'
                    ...
                    NODE_file='../Figures/Continuous/Wandercraft_id/'
                              ...
                              'KKL_u0T_back/0.36006578937808265_autograd_200samples_noise0.0_NODE_difftraj265_Adam0.008_KKL_u0T_back100/Learn_NODE.pkl',
    ...
    if train:
        ...
        #        '/Continuous/Wandercraft_id/MLPn_noisy_inputs/x1dotx2/7-29-2difftraj_0' \
        #        '.001subsampling_200samples_filter_gaussian50_butteru/KKLu_back_optimD' \
        #        '/Ok1_diag2_dz50_autograd_200samples_noise0.0_NODE_difftraj265_Adam0' \
        #        '.008_KKLu_back_optimD100'
        ...
        # df.to_csv(os.path.join(saving, 'KKLu_back_D1_x1dotx2.csv'),
        #             header=False)
        # wait = scikit-learn
    ...
    if test:
        ...
        # Evaluate NODE rollouts in case hasn't been done before
        # NODE.evaluate_rollouts(NODE.rollout_list, plots=True)  # TODO
        ...
        data_folder = '../Data/Wandercraft_id/preprocessing/' \
                      ...
                      # '7-29-0difftraj_0.001subsampling_222891samples_filter_gaussian50_butteru/'  # TODO
        for key in vars.keys():
            data_file = data_folder + 'data_' + key + '.pkl'
            if colab:
                with open(data_file, "rb") as fh:
        ...
        RMSE_lin_EKF = plot_NODE_lin_rollouts(  # TODO
