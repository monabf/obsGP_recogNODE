...
from wandercraft_id_NN_models import MLPn, WDC_simple_recog4, \
    WDC_single_deformation_model, WDC_x1dotx2_uaffine_submodel
...
# Imposing x1dot = x2, x3dot = x4 and control-affine dynamics in x4
...
if __name__ == '__main__':
    ...
    config = Config(system='Continuous/Wandercraft_id/MLPn_noisy_inputs/'
                    ...
                    NODE_file='../Figures/Continuous/Wandercraft_id/'
                              'MLP2_noisy_inputs/10-20difftraj_0.001subsampling_250samples_filter_gaussian100/'
                              'KKL_u0T_back/Interesting1_autograd_250samples_noise0.0_NODE_difftraj195_Adam0.001_KKL_u0T_back50/Learn_NODE.pkl',
    ...
    if train:
        ...
        f = MLPn(num_hl=5, n_in=config.n, n_hl=100, n_out=2,
                 activation=nn.SiLU())
        k = torch.tensor(0.2)
        submodel = WDC_x1dotx2_uaffine_submodel(f, k, config)  # TODO
