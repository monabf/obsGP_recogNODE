...
from wandercraft_id_NN_models import MLPn, WDC_simple_recog4, \
    WDC_single_deformation_model, RNNn, MLPn_xin
...
if __name__ == '__main__':
    ...
    config = Config(system='Continuous/Wandercraft_id/MLPn_noisy_inputs',
                    ...
                    NODE_file='../Figures/Continuous/Wandercraft_id/'
                              'MLPn_noisy_inputs/7-29-2difftraj_0.001subsampling_200samples_filter_gaussian50_butteru/'
                              'KKLu_back/Good1_optimD1_autograd_200samples_noise0.0_NODE_difftraj265_Adam0.008_KKLu_back100/Learn_NODE.pkl',
    ...
    if 'KKL_u0T' in config.init_state_obs_method:
        ...
        D = torch.tensor([[-1.8474e+01, -4.2819e+00, -4.2610e+00,
                           -3.6734e+00, -8.0365e+00,
                           -8.7800e+00, -1.0980e+01, -2.2556e+00,
                           1.0720e+01, -3.8795e-01],
                          [-2.1512e+00, -2.6660e+01, -3.0679e+00,
                           -3.9345e+00, -5.7781e+00,
                           -4.1870e+00, -8.3926e+00, -6.0282e+00,
                           5.7000e+00, -6.4706e-01],
                          [-1.3528e+00, -3.4638e+00, -3.4646e+01,
                           -2.7246e+00, -5.8220e+00,
                           -5.0300e+00, -1.2631e+01, -3.3517e+00,
                           6.7464e+00, -7.7474e-01],
                          [-2.2409e+00, -9.4713e-01, -8.8194e-01,
                           -4.5214e+01, -6.0542e+00,
                           -5.2720e+00, -9.4771e+00, -1.6663e-01,
                           5.6003e+00, -4.9630e-01],
                          [1.1417e+01, 4.8758e+00, 8.3621e+00, 3.9322e+00,
                           -5.4376e+01,
                           -4.9032e-01, -4.7565e+00, 5.2328e+00, 2.9748e+01,
                           1.1097e+01],
                          [7.7382e+00, 1.1984e+01, 1.0785e+01, 9.1461e+00,
                           3.5487e+00,
                           -6.0973e+01, -2.2682e+00, 1.4288e+01, 3.3318e+01,
                           1.2111e+01],
                          [1.7837e+01, 1.2790e+01, 1.9590e+01, 1.8734e+01,
                           1.0185e+01,
                           1.3191e+01, -8.1477e+01, 1.4725e+01, 2.8341e+01,
                           2.3872e+01],
                          [1.2653e+00, -1.5949e+00, -1.5168e+00, 5.5937e-02,
                           -4.6892e+00,
                           -1.1371e+00, 1.1692e-01, -9.1007e+01, 5.5278e+00,
                           1.0514e-01],
                          [-6.9920e+00, -6.3658e+00, -7.2090e+00,
                           -9.0941e+00, -1.0793e+01,
                           -7.8995e+00, -1.5955e+01, -6.1372e+00,
                           -1.0304e+02, -8.6409e+00],
                          [1.7628e+00, 1.4198e+00, -1.1623e-01, 8.8766e-02,
                           -1.4570e+00,
                           -6.5718e-01, -5.5938e+00, 1.5948e+00, 1.7220e+00,
                           -1.0060e+02]])
        ...
        # data = pd.read_csv('../Data/Wandercraft_id/KKLu_back_D1.csv',
        #                    sep=',', header=None)
    ...
    if train:
        ...
        # checkpoint_path = '../Figures/Continuous/Wandercraft_id' \
        #                '/MLPn_noisy_inputs/Residuals/0-30difftraj_0.005subsampling_40samples_filter_gaussian50/y0T_u0T/0.03194210525599184_autograd_40samples_noise0.0_NODE_difftraj761_Adam0.0005_y0T_u0T20/tb_logs/default/version_0/checkpoints/epoch=269-step=20789.ckpt'
    ...
    if test:
        ...
        # # Shorten nb of difftraj: get rid of some data to shorten computation
        # nb_difftraj_max = int(np.min([1, len(X_test)]))  # TODO
        ...
        # X_test = X_test[23].reshape(1, X_test.shape[1], X_test.shape[2])
        # U_test = U_test[23].reshape(1, U_test.shape[1], U_test.shape[2])
