...
# Use this function instead of torchdiffeq directly as much as possible:
# slight differences in params/defaults might lead to differences in
# simulation result for systems that are chaotic/very sensitive to solver!
